...
module UdonType =
  open VRC.Udon.Graph.NodeRegistries
  ...
  let getAllSupported () =
    seq {
      ...
      yield
        "System.Collections.Generic.List`1[[UnityEngine.Object, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]",
